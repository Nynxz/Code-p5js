...
function assignmentDraw(x, y) {
  if ((x % 2 == 0 && y % 3 == 0)) {
    new Section(x, y, 'circle', 'red', 'yellow', 'blue');  //1ST PART
  }
  else if ((x % 2 == 0 && y % 3 == 1)) {
    new Section(x, y, 'square', 'yellow', 'blue', 'red'); //2ND PART
  }
  else if ((x % 2 == 0 && y % 3 == 2)) {
    new Section(x, y, 'triangle', 'blue', 'red', 'yellow'); //3RD PART
  }
  else if ((x % 2 == 1 && y % 3 == 0)) {
    new Section(x, y, 'rectangle', 'red', 'blue', 'yellow');  //4TH PART
  }
  else if ((x % 2 == 1 && y % 3 == 1)) {
    new Section(x, y, 'trapezoid', 'yellow', 'red', 'blue');  //5TH PART
  }
  else if ((x % 2 == 1 && y % 3 == 2)) {
...
class Section {
  constructor(x, y, shape, shapeFillColour, verticalLineColour, horizontalLineColour) {
    ...
    this.verticalLineColour = verticalLineColour;
  ...
  drawShape() {
    rectMode(CENTER);
    if (!this.drawoutline) {
      stroke(this.verticalLineColour);
      fill(this.shapeFillColour);
    } else {
