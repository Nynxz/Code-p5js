...
function preload(){
    groups = {
        StartGroup: StartGroup = new Group(),
        PreRaceGroup: PreRaceGroup = new Group()
    };
    let drawLayer = new Group();
...
function setup() {
    ...
    {name: 'Race', OnClick: ChangeDrawLayer.bind(null, PreRaceGroup)},
    ...
    raceMenu = new Menu(PreRaceGroup,
        ...
        {name: 'Map Select'},
        {name: 'Race!'},
        {name: 'Return', OnClick: ShowButtons.bind(null, StartGroup)}
    )
    //frameRate(5);
    ChangeDrawLayer(StartGroup)
}
