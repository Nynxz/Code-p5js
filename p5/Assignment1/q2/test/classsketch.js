...
function setup() {
    FavoriteMovies = new PieChartData({'Comedy': 4, 'Action': 5, 'Romance': 6, 'Drama': 1, 'SciFi': 4});
    ...
    FavoriteMovies.drawPieChart(300, 1, 1);

    button = createButton('New Colours');
    button.position(15, 465);
    button.mousePressed(setup);
}

class PieChartData  {
    //WHAT IS 'THIS'!?!?    heh, get it.
    // Key: Value  | String: Int  - pairs
    ...
    drawPieChart(size, drawLegend, drawDynamicLabels) {
        let angle = 0;
